...
extratrees: dependencies
	$(ENSURE_LOG_DIR)
	$(CLEAR_CMD)
	$(call RUN_AND_LOG, ./extratrees.py $(ARGS))
...
# Configuration Sections Standardizer
configuration_sections_standardizer: dependencies
	$(ENSURE_LOG_DIR)
	$(CLEAR_CMD)
...
function_size_reporter: dependencies
	$(ENSURE_LOG_DIR)
	$(CLEAR_CMD)
	$(call RUN_AND_LOG, ./Scripts/function_size_reporter.py $(ARGS))
...
imports_placement: dependencies
	$(ENSURE_LOG_DIR)
	$(CLEAR_CMD)
	$(call RUN_AND_LOG, ./Scripts/imports_placement.py $(ARGS))

# Imports Scanner
imports_scanner: dependencies
	$(ENSURE_LOG_DIR)
	$(CLEAR_CMD)
	$(call RUN_AND_LOG, ./Scripts/imports_scanner.py $(ARGS))
...
standalone_comments_cleaner: dependencies
	$(ENSURE_LOG_DIR)
	$(CLEAR_CMD)
	$(call RUN_AND_LOG, ./Scripts/standalone_comments_cleaner.py $(ARGS))
