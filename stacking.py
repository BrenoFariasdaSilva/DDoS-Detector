                        ...
                        if df_augmented is not None:
                            ...
                            if df_augmented_cleaned is not None and not df_augmented_cleaned.empty:
                                ...
                                for key in results_original.keys():
                                    ...
                                    print(f"    {BackgroundColors.GREEN}Original:{Style.RESET_ALL} {orig_metrics[0]:.4f} | {BackgroundColors.YELLOW}Augmented:{Style.RESET_ALL} {aug_metrics[0]:.4f} | {BackgroundColors.BOLD}Original+Augmented:{Style.RESET_ALL} {merged_metrics[0]:.4f} | {BackgroundColors.CYAN}Improvement: {acc_improvement:+.2f}%{Style.RESET_ALL}")
                                    print(f"  {BackgroundColors.YELLOW}Precision:{Style.RESET_ALL}")
                                    print(f"    {BackgroundColors.GREEN}Original:{Style.RESET_ALL} {orig_metrics[1]:.4f} | {BackgroundColors.YELLOW}Augmented:{Style.RESET_ALL} {aug_metrics[1]:.4f} | {BackgroundColors.BOLD}Original+Augmented:{Style.RESET_ALL} {merged_metrics[1]:.4f} | {BackgroundColors.CYAN}Improvement: {prec_improvement:+.2f}%{Style.RESET_ALL}")
                                    print(f"  {BackgroundColors.YELLOW}Recall:{Style.RESET_ALL}")
                                    print(f"    {BackgroundColors.GREEN}Original:{Style.RESET_ALL} {orig_metrics[2]:.4f} | {BackgroundColors.YELLOW}Augmented:{Style.RESET_ALL} {aug_metrics[2]:.4f} | {BackgroundColors.BOLD}Original+Augmented:{Style.RESET_ALL} {merged_metrics[2]:.4f} | {BackgroundColors.CYAN}Improvement: {rec_improvement:+.2f}%{Style.RESET_ALL}")
                                    print(f"  {BackgroundColors.YELLOW}F1-Score:{Style.RESET_ALL}")
                                    print(f"    {BackgroundColors.GREEN}Original:{Style.RESET_ALL} {orig_metrics[3]:.4f} | {BackgroundColors.YELLOW}Augmented:{Style.RESET_ALL} {aug_metrics[3]:.4f} | {BackgroundColors.BOLD}Original+Augmented:{Style.RESET_ALL} {merged_metrics[3]:.4f} | {BackgroundColors.CYAN}Improvement: {f1_improvement:+.2f}%{Style.RESET_ALL}")
                                    print(f"  {BackgroundColors.YELLOW}FPR (lower is better):{Style.RESET_ALL}")
                                    print(f"    {BackgroundColors.GREEN}Original:{Style.RESET_ALL} {orig_metrics[4]:.4f} | {BackgroundColors.YELLOW}Augmented:{Style.RESET_ALL} {aug_metrics[4]:.4f} | {BackgroundColors.BOLD}Original+Augmented:{Style.RESET_ALL} {merged_metrics[4]:.4f} | {BackgroundColors.CYAN}Change: {fpr_improvement:+.2f}%{Style.RESET_ALL}")
                                    print(f"  {BackgroundColors.YELLOW}FNR (lower is better):{Style.RESET_ALL}")
                                    print(f"    {BackgroundColors.GREEN}Original:{Style.RESET_ALL} {orig_metrics[5]:.4f} | {BackgroundColors.YELLOW}Augmented:{Style.RESET_ALL} {aug_metrics[5]:.4f} | {BackgroundColors.BOLD}Original+Augmented:{Style.RESET_ALL} {merged_metrics[5]:.4f} | {BackgroundColors.CYAN}Change: {fnr_improvement:+.2f}%{Style.RESET_ALL}")
                                    print(f"  {BackgroundColors.YELLOW}Training Time (seconds, lower is better):{Style.RESET_ALL}")
                                    print(f"    {BackgroundColors.GREEN}Original:{Style.RESET_ALL} {orig_metrics[6]:.2f}s | {BackgroundColors.YELLOW}Augmented:{Style.RESET_ALL} {aug_metrics[6]:.2f}s | {BackgroundColors.BOLD}Original+Augmented:{Style.RESET_ALL} {merged_metrics[6]:.2f}s | {BackgroundColors.CYAN}Change: {time_improvement:+.2f}%{Style.RESET_ALL}\n")
