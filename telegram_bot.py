...
class TelegramBot:
   ...
   async def send_message(self, text, chat_id=None):
      ...
      self.verbose_output(f"{BackgroundColors.GREEN}Sending message to chat ID {BackgroundColors.CYAN}{chat_id}{Style.RESET_ALL}") # Output the verbose message
   ...
   async def send_long_message(self, text, chat_id=None):
      ...
      self.verbose_output(f"{BackgroundColors.GREEN}Sending long message to chat ID {BackgroundColors.CYAN}{chat_id}{Style.RESET_ALL}") # Output the verbose message
   ...
   async def run_bot(self, messages, chat_id=None):
      ...
      self.verbose_output(f"{BackgroundColors.GREEN}Running Telegram bot to send messages to chat ID {BackgroundColors.CYAN}{chat_id}{Style.RESET_ALL}") # Output the verbose message
